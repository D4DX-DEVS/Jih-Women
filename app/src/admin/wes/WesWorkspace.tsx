...
import { API_URL, apiJson, apiRequest, formatDate } from '../shared/api';
import { UploadSpec } from '../shared/ui';
...
export default function WesWorkspace({
  token,
  onLogout,
  onToast,
}: {
  ...
  return (
    <section>
      <header
        className="sticky z-20 border-b border-[#e6e8f0] bg-white"
      ...
      <div className="glass p-6">
        ...
        <form onSubmit={onUpload} className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            />
            <UploadSpec>
              1000&times;1000px square PNG. Keep the QR&rsquo;s white quiet zone intact and do
              not place anything over the code. Stored exactly as uploaded and shown at 224px,
              so it must be sharp &mdash; <strong>maximum 5MB</strong>.
            </UploadSpec>
          </div>
          <div>
            <label className="block text-xs font-medium uppercase tracking-wider text-foreground/60 mb-1.5">
          ...
          <div className="glass-strong w-[min(92vw,36rem)] p-7 md:p-8">
            ...
            <form onSubmit={onSaveEdit} className="grid grid-cols-1 gap-4">
              ...
              <div>
                ...
                <UploadSpec>
                  1000&times;1000px square PNG, quiet zone intact, <strong>maximum 5MB</strong>.
                </UploadSpec>
              </div>
    ...
    <div className="space-y-6">
      ...
      <div className="glass p-6">
        ...
        <form onSubmit={onUpload} className="space-y-4">
          ...
          <UploadSpec>
            <strong>Up to 20 files per upload.</strong> Photos: 1920px on the long edge or larger
            &mdash; they are resized to 1920px and converted to WebP automatically, and the grid
            crops each tile to a square, so keep the subject centred. Videos: MP4 (H.264) at 1080p
            and <strong>under about 50MB</strong> &mdash; videos are stored exactly as uploaded and
